...
<element>32|HKLM|SOFTWARE|Microsoft\Windows\CurrentVersion\Uninstall\{2C14E1A2-C4EB-466E-8374-81286D723D3A}</element>
</RegKeys>
<UserModeService>
<element>Sophos MCS Agent</element>
...
<MSP>
<FoldersFiles>
<element>NATIVE|PROGRAMDATA|Sophos\Sophos Malicious Script Protection\logs\SophosMaliciousScriptProtection.log</element>
<element>NATIVE|PROGRAMDATA|Sophos\Sophos Malicious Script Protection\logs\SophosMaliciousScriptProtection.log.lock</element>
<element>NATIVE|PROGRAMDATA|Sophos\Sophos Malicious Script Protection\logs</element>
<element>NATIVE|PROGRAMDATA|Sophos\Sophos Malicious Script Protection</element>
<element>NATIVE|PROGRAMFILES|Sophos\Sophos Malicious Script Protection\SophosAmsiProvider.dll</element>
<element>NATIVE|PROGRAMFILES|Sophos\Sophos Malicious Script Protection</element>
</FoldersFiles>
<FridendlyName>
<element>Sophos Malicious Script Protection</element>
</FridendlyName>
<PFRO>
<element>NATIVE|PROGRAMDATA|Sophos\Sophos Malicious Script Protection\Logs</element>
</PFRO>
...
<RegKeys>
<element>NATIVE|HKLM|SOFTWARE|Microsoft\Windows\CurrentVersion\Uninstall\{0EA5323F-DE1B-480C-911E-7827E5EA20E9}</element>
<element>NATIVE|HKLM|SOFTWARE|Microsoft\Windows\AMSI\Providers\{19016286-87D5-4D51-A042-2A9C5CBB8D5F}</element>
<element>NATIVE|HKLM|SOFTWARE|Classes\CLSID\{19016286-87D5-4D51-A042-2A9C5CBB8D5F}</element>
<element>32|HKLM|SOFTWARE|Classes\CLSID\{19016286-87D5-4D51-A042-2A9C5CBB8D5F}</element>
</RegKeys>
<UninstallCMDs>
<element>NATIVE|PROGRAMFILES|Sophos\Sophos Malicious Script Protection\Uninstall.exe!/quiet</element>
</UninstallCMDs>
</MSP>
<MDR>
<UserModeService>
<element>Sophos Managed Detection and Response</element>
</UserModeService>
<FoldersFiles>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response\Logs</element>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response\Data\osquery.db</element>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response\Data</element>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response\Config</element>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response</element>
<element>NATIVE|PROGRAMFILES|Sophos\Managed Detection and Response</element>
</FoldersFiles>
<FridendlyName>
<element>Sophos Managed Detection and Response</element>
</FridendlyName>
<Processes>
<element>SophosMDR.exe</element>
<element>SophosMDRTelemetry.exe</element>
<element>SophosMDRUninstall.exe</element>
</Processes>
<PFRO>
<element>NATIVE|PROGRAMDATA|Sophos\Managed Detection and Response</element>
<element>NATIVE|PROGRAMFILES|Sophos\Managed Detection and Response</element>
...
<RegKeys>
<element>NATIVE|HKLM|SYSTEM|CurrentControlSet\Services\Sophos Managed Detection and Response</element>
<element>32|HKLM|SOFTWARE|Sophos\Remote Management System\ManagementAgent\Adapters\MDR</element>
<element>NATIVE|HKLM|SOFTWARE|Microsoft\Windows\CurrentVersion\Uninstall\Sophos MDR</element>
</RegKeys>
<UninstallCMDs>
<element>NATIVE|PROGRAMFILES|Sophos\Managed Detection and Response\SophosMDRUninstall.exe!/quiet</element>
</UninstallCMDs>
</MDR>
<SLQ>
<FoldersFiles>
<element>NATIVE|PROGRAMFILES|Sophos\Live Query</element>
</FoldersFiles>
<FridendlyName>
<element>Sophos Live Query</element>
</FridendlyName>
<Processes>
<element>SophosOSQueryExtension.exe</element>
<element>SophosOsquery.exe</element>
<element>SophosLiveQueryUninstall.exe</element>
</Processes>
<PFRO>
<element>NATIVE|PROGRAMFILES|Sophos\Live Query</element>
</PFRO>
<RegKeys>
<element>NATIVE|HKLM|SOFTWARE|Microsoft\Windows\CurrentVersion\Uninstall\Sophos Live Query</element>
</RegKeys>
<UninstallCMDs>
<element>NATIVE|PROGRAMFILES|Sophos\Live Query\SophosLiveQueryUninstall.exe!/quiet</element>
</UninstallCMDs>
</SLQ>
<SED>
<Driver>
...
<MSIProductCodes>
<element>85F78DA7-8E8E-49C9-969F-A62D2B43C046</element>
...
<element>FAF9F9B7-9E8D-4429-A31C-39FBD65A5E57</element>
</MSIProductCodes>
<PFRO>
<element>NATIVE|WINDOWS|System32\Drivers|savonaccess.sys</element>
<element>NATIVE|WINDOWS|System32\Drivers|swi_callout.sys</element>
...
function Main()
{
    ...
    Write-Host " - SophosZap is the supported 'force' removal tool for removing the Sophos Endpoint software."
    Write-Host " - Please use SophosZap in preference to this script.  For information, see article 134486."
	Write-Host " - This script is no longer being maintained."
    Write-Host "====================================================================================================================="
    Write-Host "Notes for this script:"
    Write-Host " - Supported methods should be tried before running this script.  E.g. 'Programs and Features' or SophosZap."
    ...
    if ($InstalledSoftware)
    {
        ...
        {
            Log-Write "$($a.DisplayName) - $($a.DisplayVersion) - $($a.PSChildName)" "INFO" 
        }
    }
    else
    {
   ...
   #11 STAS check
    ...
    if($SEDState.$strSEDEnabled -gt 0)
    {
        ...
        if ($global:boolForceMode)
        {
            ...
            {
                Log-Write "Tamper Protection (SED) is enabled. SEDEnabled value is $($SEDState.$strSEDEnabled)." "INFO"
                if (-not $Password)
                {
